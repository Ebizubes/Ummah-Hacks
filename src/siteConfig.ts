export const siteConfig = {
  ...
  sponsors: [
    ...
    },
    {
      ...
      tier: 'tier1',
      url: 'https://example.com/ummah',
    },
    {
      name: 'Automax AI',
      logo: '/sponsors/automax_ai.jpg',
      tier: 'tier1',
      url: 'https://example.com/automax-ai',
    },
    {
      name: 'Insforge',
      logo: '/sponsors/insforge_logo.jpg',
      tier: 'tier2',
      url: 'https://example.com/insforge',
    },
    {
      name: 'Rushad',
      logo: '/sponsors/insforge_logo.jpg',
      tier: 'tier2',
      url: 'https://example.com/rushad',
    },
    {
      name: 'Upcoming VC in Sauga',
      logo: '/sponsors/insforge_logo.jpg',
      tier: 'tier2',
      url: 'https://example.com/upcoming-vc-sauga',
    },
    {
      name: 'Breakthrough Ventures',
      logo: '/sponsors/breakthrough_ventures.jpg',
      tier: 'tier3',
      url: 'https://example.com/breakthrough-ventures',
    },
    {
      name: 'ASL Aspire',
      logo: '/sponsors/asl_aspire_logo.jpg',
      tier: 'tier3',
      url: 'https://example.com/asl-aspire',
    },
    {
      name: 'Amano',
      logo: '/sponsors/amano.jpg',
      tier: 'tier3',
      url: 'https://example.com/amano',
    },
  ],
}
